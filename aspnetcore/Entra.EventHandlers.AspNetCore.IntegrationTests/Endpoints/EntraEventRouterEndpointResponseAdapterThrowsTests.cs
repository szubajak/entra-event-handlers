...
public class EntraEventRouterEndpointResponseAdapterThrowsTests(TestAppFactoryResponseAdapterThrows factory) : IClassFixture<TestAppFactoryResponseAdapterThrows>
{
    private readonly HttpClient _client = factory.CreateClient();

    [Fact]
    public async Task Router_ShouldReturnServerError_WhenResponseAdapterFails()
    {
        // Arrange
